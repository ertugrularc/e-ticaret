...
import valuesFunc from "./single-product/value.js";
...
// SRCYİ YAZMAMIZIN NEDENİ SRCYİ DEĞİŞTİRMEK İSTEDİĞİMİZDEN
singleImageDOM.src = findProduct.img.singleImage;

const galleryThumbs = document.querySelector(".gallery-thumb");
let result = " ";
