...
function productsFunc(products) {
  ...
  let results = "";
  // dizideki her bir elemana ulaşıldığında çağrılır
  products.forEach((item) => {
    ...
    // JS ile Html DOM üzerindeki bir öğenin içeriğini Html kodları ile birlikte alabilir veya seçtiğimiz Html öğesinin içerisine Html kodları ekleyebiliriz
